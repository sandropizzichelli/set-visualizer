...
function ControlSection({ eyebrow, title, children }) {
  return (
  ...
  return (
    <div className="set-panel set-panel--hero">
      ...
      <div className="control-grid">
        <ControlSection eyebrow="Selezione del set" title="Classe e accesso">
        ...
        <ControlSection eyebrow="Lettura del set" title="Come leggere il manico">
          <div className="control-card">
            <div className="control-card__stack">
